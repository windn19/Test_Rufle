...
после окончания нагрузки испытукмый ложится, и у него внось подсчитывается число пульсаций за первые 15 секунд,
...
сильная одышка и др.), то тест необъдимо прервать и обратиться к врачу.
"""
